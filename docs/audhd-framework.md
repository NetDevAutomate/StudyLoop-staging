...
**Response:** Reframe with evidence. Review spaced repetition progress via `studyloop review` and surface concepts that have moved to longer intervals (indicating mastery). Keep celebrations factual and specific — empty praise triggers AuDHD suspicion.
