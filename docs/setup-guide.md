...
# Opens browser, prints LAN URLs:
#   Dashboard: http://192.168.1.42:8567/session
#   Terminal:  http://192.168.1.42:7681
```

Access the live dashboard and embedded terminal from your iPad at `http://<mac-ip>:8567/session`. ttyd must be installed for the terminal panel to work (`brew install ttyd`).
