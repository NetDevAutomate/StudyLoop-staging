...
def topics_list(tech: str | None, source: str | None, show_all: bool) -> None:
    ...
    from studyloop.logic.backlog_logic import BacklogItem, format_backlog_list
...
def topics_suggest(limit: int, topic: str | None) -> None:
    ...
    Examples:
        ...
        studyloop backlog suggest --limit 5

        studyloop backlog suggest --topic "Python Patterns"
    """
    from rich.table import Table
