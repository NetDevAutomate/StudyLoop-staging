...
from studyloop.logic.break_logic import THRESHOLDS as _BREAK_THRESHOLDS
from studyloop.logic.break_logic import BreakSuggestion, check_break_needed
from studyloop.logic.break_logic import energy_band as _energy_band
