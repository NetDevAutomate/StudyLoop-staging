...
class TestGetCourseStats:
    def test_empty_db(self, db_path: Path) -> None:
        from studyloop.review_db import ensure_tables, get_course_stats
    ...
    def test_with_reviews(self, db_path: Path) -> None:
        from studyloop.review_db import get_course_stats, record_card_review
...
class TestGetDueCards:
    def test_empty_db(self, db_path: Path) -> None:
        from studyloop.review_db import ensure_tables, get_due_cards
...
class TestGetWrongHashes:
    def test_returns_wrong_from_last_session(self, db_path: Path) -> None:
        from studyloop.review_db import get_wrong_hashes, record_card_review, record_session
    ...
    def test_empty_db(self, db_path: Path) -> None:
        from studyloop.review_db import ensure_tables, get_wrong_hashes
