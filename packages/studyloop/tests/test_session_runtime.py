...
from studyloop.session_runtime import (
    AgentSessionManager,
    PtyAgentSessionTransport,
    SessionStartSpec,
)
from studyloop.session_runtime.manager import _acp_command
from studyloop.session_runtime.pty import _merged_env, clean_terminal_output
...
async def test_manager_falls_back_to_shell_when_no_agent_detected(
    ...
    monkeypatch.setattr("studyloop.session_runtime.manager._default_agent", lambda: "shell")
