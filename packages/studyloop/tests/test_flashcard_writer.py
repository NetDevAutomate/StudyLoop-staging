...
from studyloop.services.flashcard_writer import (
    _card_hash,
    _existing_card_hashes,
    write_session_flashcards,
)
from studyloop.session_state import TopicEntry
...
class TestExistingCardHashes:
    ...
    def test_skips_malformed_json_files(self, tmp_path, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="studyloop.services.flashcard_writer"):
            hashes = _existing_card_hashes(fc_dir)
