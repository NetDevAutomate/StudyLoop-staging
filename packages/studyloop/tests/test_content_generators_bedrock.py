...
from studyloop.content.generators.bedrock import (  # noqa: E402
    _FLASHCARD_TOOL_NAME,
    _QUIZ_TOOL_NAME,
    BedrockGenerator,
)
from studyloop.content.schemas import FlashcardDeck, QuizDeck  # noqa: E402
from studyloop.settings import BedrockBackendConfig, CardGeneratorConfig  # noqa: E402
...
class TestProfileFallback:
    def test_missing_bedrock_extra_raises_helpful_error(
        ...
        """If boto3 import fails, surface a 'pip install studyloop[bedrock]' hint."""
        import builtins
        ...
        with pytest.raises(CardGenerationError, match=r"pip install 'studyloop\[bedrock\]'"):
