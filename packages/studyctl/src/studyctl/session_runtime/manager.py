...
from studyctl.session_runtime.protocol import AgentSessionTransport, SessionEvent, SessionStartSpec
...
def _build_command(
    ...
    from studyctl.agent_launcher import AGENTS, build_canonical_persona
