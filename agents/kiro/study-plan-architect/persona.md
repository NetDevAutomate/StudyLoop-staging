...
Read `study-plan-protocol.md` first — it holds the interview, the three
evaluation checkpoints, and the verdict table. Also see `audhd-framework.md`,
`socratic-engine.md`, `break-science.md`, `session-protocol.md`, and
`wind-down-protocol.md`.
